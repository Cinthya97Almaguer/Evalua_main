...
namespace Evalua
{
    public class Lexico : Token
    {
        ...
        {
            linea = 1;
            string path = "C:\\Users\\Cinthya Almaguer\\OneDrive\\Documentos\\Visual Studio 2022\\Evalua-main\\prueba.cpp";
            bool existencia = File.Exists(path);
            log = new StreamWriter("C:\\Users\\Cinthya Almaguer\\OneDrive\\Documentos\\Visual Studio 2022\\Evalua-main\\prueba.Log"); 
            log.AutoFlush = true;
